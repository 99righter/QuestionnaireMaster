...
/** aiSseGenerateQuestion GET /api/question/ai_generate/sse */
export async function aiSseGenerateQuestionUsingGet(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.aiSseGenerateQuestionUsingGETParams,
  options?: { [key: string]: any },
) {
